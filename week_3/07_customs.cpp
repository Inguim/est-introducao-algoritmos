...
int main() {
    ...
    if (code >= 8) weightCost = 35.0;
    else if (code >= 5) weightCost = 25.0;
    else weightCost = 10.0;

    cout << weight * 1000 << endl;
    cout << (weight * 1000) * weightCost << endl;
    cout << ((weight * 1000) * weightCost) * tax << endl;
    cout << ((weight * 1000) * weightCost) * (1.0 + tax) << endl;
